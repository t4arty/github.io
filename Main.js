...
function getGroupMembers(objTarget) {
    ...
    var code1 = 'var a=API.likes.getList({"type":"post","owner_id":"'+aboutPost[0]+'","item_id":"'+aboutPost[1]+'","offset":0,"count":100}); return a.items;';
    ...
    VK.api('execute', { 'code': code1, }, function (data) {
        ...
        if (data.response.error) {
            ...
            bothSex = bothSex.concat(data.response);
